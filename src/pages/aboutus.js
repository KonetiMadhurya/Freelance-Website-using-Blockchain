...
const aboutus = () => {
    const founderArray = [
        { name: "Niamh O Shea", position: "Co-founder and Chief Executive", images: images.founder1, },
        { name: "Danien Jame", position: "Co-founder and Chief Executive", images: images.founder2, },
        { name: "Orla Dwyer", position: "Co-founder and Chairman", images: images.founder3, },
                        ...
                        {founderArray.map((el, i) => {
                            return (
                                <div className={Style.aboutus_box_founder_box_img}>
                                    <Image src={el.images} alt={el.name} width={500} height={500}
